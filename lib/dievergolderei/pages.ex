defmodule Dievergolderei.Pages do
  @moduledoc """
  The Pages context.
  """
  ...
  @doc """
  Get page content for a named page, raises when not found or ambiguous

  ## Examples

      iex> get_content_by_name!("test")
      String.t()
  """
  def get_content_by_name!(name) do
    StaticPage
    |> where([q], q.name == ^name)
    |> select([q], q.content)
    |> Repo.one!
