defmodule DievergoldereiWeb.UserControllerTest do
  ...
  @create_attrs %{display_name: "some display_name", email: "email@example.com", password_hash: "some password_hash"}
  @update_attrs %{display_name: "some updated display_name", email: "email@example.com", password_hash: "some updated password_hash"}
