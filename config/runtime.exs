...
#
#     PHX_SERVER=true bin/dievergolderei start
#
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "dievergolderei.ch"
  ...
  #
  config :dievergolderei, Dievergolderei.Mailer,
  ...
  #
  config :swoosh, :api_client, Dievergolderei.Finch
  #
